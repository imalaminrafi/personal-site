...
function DefaultFallback({ onRetry, error }: { onRetry: () => void; error: Error | null }) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-6 dark:bg-zinc-950">
      <div className="text-center max-w-md">
        ...
        {error && (
          <details className="mt-8 text-left">
            ...
            <pre className="mt-3 p-4 bg-zinc-100 dark:bg-zinc-900 rounded-xl text-xs text-red-600 dark:text-red-400 overflow-auto max-h-40 border border-zinc-200 dark:border-zinc-800">
              {error.message}
            </pre>
          </details>
        )}
