        ...
        <>
            <header
                className={cn(
                    ...
                    isScrolled
                        ? "py-2 sm:py-3 bg-white/95 dark:bg-[#0F172A]/95 border-b border-zinc-200 dark:border-white/[0.06] shadow-sm backdrop-blur-sm"
            ...
            {isMenuOpen && (
                ...
                >
                    ...
                    <div className="px-5 pb-10 pt-4 border-t border-white/[0.08] bg-[#0F172A]">
                        {user && (
