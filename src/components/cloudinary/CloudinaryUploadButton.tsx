      ...
      {value ? (
        isRaw ? (
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-36 h-24 rounded-xl border border-zinc-200 dark:border-white/[0.08] shrink-0 bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center">
