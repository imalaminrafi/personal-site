...
export default function MediaLibraryPicker({
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-[#0d0b1f] rounded-3xl border border-zinc-200 dark:border-white/[0.08] shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden"
        ...
        <div className="px-5 pt-4 space-y-3 shrink-0">
          ...
          <div className="flex items-center gap-2 flex-wrap">
              ...
              {(["all", "image", "raw", "video"] as MediaPickerFilter[]).map((f) => (
                <button
                  ...
                  className={cn(
                    ...
                    typeFilter === f
                      ? "bg-white dark:bg-[#1a1730] text-violet-600 dark:text-violet-400 shadow-sm"
            ...
            <select
              ...
              className="px-2.5 py-1.5 rounded-lg border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] text-[11px] font-medium text-zinc-700 dark:text-zinc-300 focus:outline-none"
            >
              {folders.map((f) => (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {pageItems.map((m) => {
                ...
                return (
                  ...
                  >
                    {isRaw || isVideo ? (
                      <div className="aspect-square bg-zinc-100 dark:bg-zinc-900 flex flex-col items-center justify-center gap-2">
