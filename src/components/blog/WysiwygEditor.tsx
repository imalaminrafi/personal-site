...
export default function WysiwygEditor({ value, onChange, onAutoSave }: WysiwygEditorProps) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-white/[0.08] overflow-hidden bg-white dark:bg-[#0d0b1f]">
      <div className="flex flex-wrap items-center gap-0.5 px-3 py-2 border-b border-zinc-200 dark:border-white/[0.08] bg-zinc-50/50 dark:bg-zinc-900/50 sticky top-0 z-10">
        {/* History */}
        ...
        <div className="relative">
          ...
          {showFontSize && (
            <div className="absolute top-full left-0 mt-1 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-white/[0.08] shadow-xl p-1.5 flex gap-1 z-20">
        ...
        <div className="relative">
          ...
          {showColors && (
            <div className="absolute top-full left-0 mt-1 bg-white dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-white/[0.08] shadow-xl p-2 z-20">
        ...
        {showLinkInput && (
          <div className="flex items-center gap-2 ml-2">
            <input type="url" value={linkUrl} onChange={(e) => setLinkUrl(e.target.value)} placeholder="https://..." className="px-2 py-1 rounded-lg border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-zinc-900 text-xs w-48 focus:outline-none" autoFocus onKeyDown={(e) => { if (e.key === "Enter") addLink(); if (e.key === "Escape") setShowLinkInput(false); }} />
      ...
      <div className="flex items-center justify-between px-6 py-2 border-t border-zinc-200 dark:border-white/[0.08] bg-zinc-50/50 dark:bg-zinc-900/50 text-[11px] text-zinc-500">
