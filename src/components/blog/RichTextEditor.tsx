...
export default function RichTextEditor({ value, onChange }: RichTextEditorProps) {
  ...
  return (
    <div className="rounded-xl border border-zinc-200 dark:border-[#1E3A5F] overflow-hidden bg-zinc-50 dark:bg-[#162032]">
      <div className="flex items-center justify-between px-3 py-2 border-b border-zinc-200 dark:border-[#1E3A5F] bg-white dark:bg-[#162032]">
