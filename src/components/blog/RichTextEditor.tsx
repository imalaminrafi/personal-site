...
export default function RichTextEditor({ value, onChange }: RichTextEditorProps) {
  ...
  return (
    <div className="rounded-xl border border-zinc-200 dark:border-white/[0.08] overflow-hidden bg-zinc-50 dark:bg-[#162032]">
      <div className="flex items-center justify-between px-3 py-2 border-b border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#162032]">
        ...
        <div className="flex items-center gap-1 bg-zinc-100 dark:bg-[#1E293B] rounded-lg p-0.5">
          <button
            type="button"
