...
export default function ImageUploader({ value, onChange, label = "Image" }: ImageUploaderProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {tab === "upload" && (
        <div className="border-2 border-dashed border-zinc-200 dark:border-white/[0.08] rounded-xl p-6 text-center">
      ...
      {tab === "url" && (
        <div className="flex gap-2">
          <input type="text" placeholder="Paste image URL..." value={urlInput} onChange={(e) => setUrlInput(e.target.value)} className="flex-1 px-3 py-2 rounded-xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] text-sm focus:outline-none" />
      ...
      {tab === "drive" && (
        <div className="flex gap-2">
          <input type="text" placeholder="Paste Google Drive share link..." value={driveInput} onChange={(e) => setDriveInput(e.target.value)} className="flex-1 px-3 py-2 rounded-xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] text-sm focus:outline-none" />
      ...
      {value && (
        <div className="relative w-32 h-32 rounded-xl overflow-hidden border border-zinc-200 dark:border-white/[0.08]">
