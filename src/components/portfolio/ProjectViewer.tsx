...
export default function ProjectViewer({ url, title }: ProjectViewerProps) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] shadow-sm">
      {/* Toolbar */}
      ...
      {/* Body */}
      <div className="relative bg-zinc-100 dark:bg-zinc-900" style={{ height: "min(70vh, 640px)" }}>
        {status === "blocked" ? (
          ...
          <>
            ...
            />
            {status === "loading" && (
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-zinc-100 dark:bg-zinc-900 pointer-events-none">
