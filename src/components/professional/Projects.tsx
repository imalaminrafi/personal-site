...
const projects: Project[] = [
    {
        ...
        image: "/projects/novatech_saas.webp",
        featured: true,
    },
    {
        ...
        image: "/projects/urbanshop_ecommerce.webp",
        featured: true,
    },
    {
        ...
        image: "/projects/zenhealth_medical.webp",
    },
    {
        ...
        image: "/projects/estatepro_realestate.webp",
    },
    {
        ...
        image: "/projects/finflow_fintech.webp",
    },
    {
        ...
        image: "/projects/creativstudio_agency.webp",
        featured: true,
    },
    {
        ...
        image: "/projects/careerpro_portfolio.webp",
    },
    {
        ...
        image: "/projects/medico_doctor_website.webp",
        featured: true,
    },
];
...
function ProjectCard({ project }: { project: Project }) {
    return (
        <div className="group bg-white dark:bg-[#162032] rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
            {/* Preview Image */}
            ...
            <div className="p-4 sm:p-6 flex flex-col grow">
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                    {project.tags.map((tag, t) => (
                        <span key={t} className="px-2 py-0.5 text-[10px] sm:text-[11px] font-medium rounded-md bg-zinc-100 dark:bg-[#1E293B]/50 text-zinc-600 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700/50 flex items-center gap-1">
                ...
                <a
                    ...
                    className="inline-flex items-center justify-center gap-2 w-full py-2 px-4 rounded-xl bg-zinc-50 dark:bg-[#1E293B]/50 text-xs sm:text-sm font-semibold text-zinc-900 dark:text-white border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors group/btn"
                >
                    View Project
...
export default function ProjectsSection({ isLanding = false }: ProjectsSectionProps) {
    ...
    return (
        <section id="projects" className={`bg-zinc-50 dark:bg-[#1E293B] border-t border-zinc-100 dark:border-white/[0.05] ${isLanding ? "py-14 sm:py-20" : "py-16 sm:py-24"}`}>
                    ...
                    <>
                        ...
                        <div className="flex gap-2 mb-6 sm:mb-10 overflow-x-auto pb-1 sm:flex-wrap sm:overflow-visible scrollbar-none">
                            {websiteTypes.map((type, i) => (
                                <span
                                    key={i}
                                    className="shrink-0 px-3 py-1.5 text-xs font-medium rounded-full bg-white dark:bg-[#1E293B]/80 text-zinc-600 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700 shadow-sm"
                                >
                                    {type}
                                </span>
                            ))}
                            ...
                            {categories.map(cat => (
                                <button
                                    ...
                                    className={`px-5 py-2 rounded-full text-sm font-medium transition-all duration-200 ${activeCategory === cat
                                            ...
                                            : "bg-white dark:bg-[#1E293B] text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700"
                                        }`}
                                >
                ...
                {!isLanding && hasMore && (
                    <div className="flex flex-col items-center gap-3 mt-12">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-7 py-3 rounded-full text-sm font-semibold bg-white dark:bg-[#1E293B] text-zinc-900 dark:text-white border border-zinc-200 dark:border-zinc-700 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
                        >
                            {showAll ? (
