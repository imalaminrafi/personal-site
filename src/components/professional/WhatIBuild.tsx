            ...
            <div className="max-w-5xl mx-auto px-5 sm:px-6">
                ...
                >
                    {websiteTypes.map(({ label, icon }, i) => (
                        <span
                            key={i}
                            className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium bg-zinc-50 dark:bg-[#1E293B]/80 text-zinc-700 dark:text-zinc-200 border border-zinc-200 dark:border-[#1E3A5F] hover:border-violet-400 dark:hover:border-violet-500 transition-colors duration-150 cursor-default"
                        >
