...
export default function ProfessionalContact() {
    ...
    const inputClasses =
        "w-full px-4 py-3.5 rounded-xl bg-zinc-50 dark:bg-[#1E293B] border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-[#C9A84C] focus:border-transparent transition-all text-[15px]";

    return (
        <section id="contact" className="bg-zinc-50 dark:bg-[#1E293B] py-12 sm:py-24 border-t border-zinc-100 dark:border-white/[0.05]">
                ...
                <div className="grid lg:grid-cols-5 gap-10">
                    ...
                    <div className="hidden lg:block lg:col-span-2 space-y-6">
                        ...
                        <a
                            ...
                            className="flex items-start gap-4 bg-white dark:bg-[#162032] p-5 rounded-2xl border border-zinc-100 dark:border-zinc-800 hover:shadow-md hover:border-violet-200 dark:hover:border-violet-800 transition-all duration-300 group"
                        >
                        ...
                        <a
                            ...
                            data-ga="whatsapp_click"
                            data-ga-location="contact"
                            className="flex items-start gap-4 bg-white dark:bg-[#162032] p-5 rounded-2xl border border-zinc-100 dark:border-zinc-800 hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-800 transition-all duration-300 group"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-start gap-4 bg-white dark:bg-[#162032] p-5 rounded-2xl border border-zinc-100 dark:border-zinc-800 hover:shadow-md hover:border-[#C9A84C]/50 dark:hover:border-[#C9A84C]/40 transition-all duration-300 group"
                        >
                            <div className="h-11 w-11 rounded-xl bg-[#C9A84C]/12 dark:bg-[#C9A84C]/15 flex items-center justify-center text-[#C9A84C] dark:text-[#E0C77E] shrink-0 group-hover:bg-[#C9A84C] group-hover:text-[#0F172A] transition-all duration-300">
                        ...
                        {/* Location */}
                        <div className="flex items-start gap-4 bg-white dark:bg-[#162032] p-5 rounded-2xl border border-zinc-100 dark:border-white/[0.08]">
                        ...
                        {/* Availability note */}
                        <div className="bg-gradient-to-r from-[#C9A84C] to-[#E6C97A] p-5 rounded-2xl text-[#0F172A]">
                    ...
                    {/* Contact Form – Right */}
                    <div id="contact-form" className="lg:col-span-3 bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-6 sm:p-8 shadow-sm scroll-mt-24">
                        {submitted ? (
