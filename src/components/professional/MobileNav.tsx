...
export default function MobileBottomNav() {
    ...
    return (
        ...
        <div className="sm:hidden fixed bottom-5 left-1/2 -translate-x-1/2 z-[70]">
            <div className="flex items-center gap-1 px-3 py-2.5 rounded-[24px] bg-white/95 dark:bg-[#162032]/95 border border-zinc-200/80 dark:border-[#1E3A5F]/60 shadow-[0_8px_32px_rgba(0,0,0,0.12)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
                {navItems.map((item) => {
