...
export default function ProfessionalAchievements() {
    return (
        <>
            {/* Key Achievements */}
            <section className="bg-white dark:bg-[#0F172A] py-14 sm:py-20 border-t border-zinc-100 dark:border-[#1E3A5F]">
            ...
            {/* Certifications */}
            <section className="bg-zinc-50 dark:bg-[#162032]/50 py-14 sm:py-20 border-t border-zinc-100 dark:border-[#1E3A5F]">
                <div className="max-w-5xl mx-auto px-5 sm:px-6">
                    ...
                    <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
                        {certifications.map((cert, i) => (
                            <div
                                key={i}
                                className="bg-white dark:bg-[#162032] rounded-xl p-3 sm:p-4 border border-zinc-100 dark:border-[#1E3A5F]"
                            >
            ...
            {/* Community */}
            <section className="bg-white dark:bg-[#0F172A] py-12 sm:py-16 border-t border-zinc-100 dark:border-[#1E3A5F]">
                <div className="max-w-5xl mx-auto px-5 sm:px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {community.map((exp, i) => (
                            <div
                                key={i}
                                className="bg-zinc-50 dark:bg-[#162032]/50 rounded-xl p-4 border border-zinc-100 dark:border-[#1E3A5F]"
                            >
