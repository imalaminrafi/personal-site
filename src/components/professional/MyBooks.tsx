...
export default function MyBooksSection() {
    ...
    return (
        <section id="books" className="bg-white dark:bg-[#0F172A] py-12 sm:py-14 border-t border-zinc-100 dark:border-[#1E3A5F]">
                    ...
                    {books.map((book) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    to={`/books/${book.id}`}
                                    className="w-[120px] h-[160px] shrink-0 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-[#C9A84C] to-[#D4B86A] flex flex-col items-center justify-center gap-2 relative"
                                >
                                    {book.cover ? (
                                        <img
