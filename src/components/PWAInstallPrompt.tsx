...
export default function PWAInstallPrompt() {
    ...
    return (
        <div className="sm:hidden fixed bottom-[90px] left-4 right-4 z-[80] animate-in slide-in-from-bottom-4 duration-300">
            <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-[0_8px_32px_rgba(0,0,0,0.12)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] p-4 flex flex-col gap-3">
                <div className="flex items-start gap-3">
                    ...
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 flex items-center justify-center shrink-0">
                        <span className="text-[#0F172A] font-bold text-sm">AR</span>
                    </div>
