...
const defaults: StoredPost[] = [
  {
    ...
    relatedSlugs: [],
    faq: [
      { question: "What does Alamin Rafi do?", answer: "Alamin Rafi is a professional website developer and designer who helps small businesses build modern, SEO-optimized websites." },
      { question: "Where is Alamin Rafi based?", answer: "Alamin Rafi is based in Bangladesh and serves clients worldwide." },
    ],
