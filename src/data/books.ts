...
const defaults: Book[] = [
  {
    ...
    cover: "/books/book-web-business.png",
    price: "$9.99",
    priceNote: "One-time purchase · Instant PDF",
    buyUrl: "https://payhip.com",
    previewUrl: "/books/book-web-business-preview.png",
    category: "Business",
    pages: 120,
    rating: 4.8,
    featured: true,
  ...
  },
  {
    ...
    cover: "/books/book-web-design.png",
    price: "$7.99",
    priceNote: "One-time purchase · Instant PDF",
    buyUrl: "https://payhip.com",
    previewUrl: "/books/book-web-design-preview.png",
    category: "Design",
    pages: 95,
    rating: 4.9,
    featured: true,
  ...
  },
  {
    ...
    cover: "/books/book-wordpress.png",
    price: "$5.99",
    priceNote: "One-time purchase · Instant PDF",
    buyUrl: "https://payhip.com",
    previewUrl: "/books/book-wordpress-preview.png",
    category: "WordPress",
    pages: 80,
    rating: 4.7,
    featured: false,
