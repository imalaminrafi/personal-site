...
export const author: AuthorProfile = {
  ...
  sameAs: [
    { platform: "LinkedIn", url: "https://linkedin.com/in/alaminrafi", icon: "linkedin" },
    { platform: "Facebook", url: "https://facebook.com/alaminrafi.dev", icon: "facebook" },
    { platform: "GitHub", url: "https://github.com/alaminrafi", icon: "github" },
    { platform: "Twitter", url: "https://twitter.com/alaminrafi_dev", icon: "twitter" },
    { platform: "Behance", url: "https://behance.net/alaminrafi", icon: "behance" },
