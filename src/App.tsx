...
function RouteLoading() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-[#0F172A]" aria-hidden="true">
      <div className="h-8 w-8 animate-spin rounded-full border-2 border-zinc-200 border-t-[#C9A84C]" />
    </div>
  );
}
