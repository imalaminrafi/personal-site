      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-6 py-10 sm:py-16">
        ...
        {sorted.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {sorted.map((t) => (
              <figure key={t.id} className="flex flex-col rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] bg-zinc-50/60 dark:bg-[#12233F] p-6 hover:border-[#C9A84C]/40 hover:shadow-lg transition-all duration-300">
