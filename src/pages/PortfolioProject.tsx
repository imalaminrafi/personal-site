      ...
      <main className="pt-24 pb-16">
        ...
        {hasCaseStudy && (
          <section id="case-study" className="max-w-6xl mx-auto px-5 sm:px-6 mt-12 scroll-mt-24">
            <div className="rounded-3xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] p-6 sm:p-10">
          ...
          <section id="reviews" className="max-w-6xl mx-auto px-5 sm:px-6 mt-12 scroll-mt-24">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {project.reviews.map((review) => (
                <div
                  key={review.id}
                  className="rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] p-5 flex flex-col"
                >
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 mt-14">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-3xl bg-gradient-to-r from-violet-600 to-cyan-500 p-6 sm:p-8">
            <div>
              <h3 className="text-lg sm:text-xl font-bold text-white">Like this project?</h3>
              <p className="text-sm text-white/80 mt-1">Let's build something great for your business too.</p>
            </div>
            <div className="flex gap-3">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-violet-700 text-sm font-bold hover:bg-zinc-100 transition-colors"
              >
                Get in Touch
              </Link>
              <Link
                to="/portfolio"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-black/20 text-white text-sm font-bold hover:bg-black/30 transition-colors"
              >
          ...
          return (
            <div className="max-w-6xl mx-auto px-5 sm:px-6 mt-10">
              <Link
                ...
                className="group flex items-center justify-between rounded-2xl border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-[#0d0b1f] p-5 hover:border-violet-300 dark:hover:border-violet-700 transition-colors"
              >
                <div>
