...
export default function AdminLogin() {
  ...
  if (mustChange) {
    return (
      <div className="min-h-screen bg-zinc-50 dark:bg-[#070711] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-[#0d0b1f] rounded-3xl border border-zinc-200 dark:border-white/[0.08] shadow-sm p-8">
