      ...
      <div className="space-y-10">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {plans.map((plan, idx) => (
              <div key={plan.id} className="bg-white dark:bg-[#162032] p-6 rounded-2xl border border-zinc-200 dark:border-white/[0.08]">
                ...
                <div className="space-y-3">
                  ...
                  <input 
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-zinc-100 dark:border-white/[0.05] bg-zinc-50 dark:bg-[#162032] text-sm"
                  ...
                  <tr key={addon.id}>
                    ...
                    <td className="px-6 py-4">
                       ...
                       <input 
                        ...
                        className="px-3 py-1.5 rounded-lg border border-zinc-100 dark:border-white/[0.05] bg-zinc-50 dark:bg-[#162032] text-sm"
             ...
             <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  <label htmlFor="maint-name" className="block text-xs font-bold text-zinc-400 uppercase mb-2">Label</label>
                   <input id="maint-name" className="w-full px-4 py-3 rounded-xl bg-zinc-50 dark:bg-[#162032] border-zinc-100 dark:border-white/[0.05]" defaultValue={maint.name} onBlur={(e) => saveMaint({ ...maint, name: e.target.value })} />
                </div>
                <div className="flex-1">
                  <label htmlFor="maint-price" className="block text-xs font-bold text-zinc-400 uppercase mb-2">Price Info</label>
                  <input id="maint-price" className="w-full px-4 py-3 rounded-xl bg-zinc-50 dark:bg-[#162032] border-zinc-100 dark:border-white/[0.05]" defaultValue={maint.priceLabel} onBlur={(e) => saveMaint({ ...maint, priceLabel: e.target.value })} />
                </div>
             </div>
          </div>
        </section>
