            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {data.focus.items.map((item, i) => (
                  <div
                    key={i}
                    className="group p-6 rounded-2xl bg-white dark:bg-[#162032]/60 border border-zinc-100 dark:border-white/[0.05] hover:border-violet-200 dark:hover:border-violet-800/40 hover:shadow-lg hover:shadow-violet-500/5 transition-all"
                  >
              ...
              <div className="space-y-8">
                {data.experience.items.map((item, i) => (
                  <div key={i} className="relative sm:pl-14">
                    ...
                    <div className="bg-white dark:bg-[#162032]/40 rounded-2xl border border-zinc-100 dark:border-white/[0.05] p-6 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.skills.categories.map((cat, i) => (
                  <div key={i} className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-white/[0.05] p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {cat.items.map((skill, j) => (
                        <span
                          key={j}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-[#1E293B] text-xs font-medium text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-white/[0.06]"
                        >
                          {skill}
                        </span>
                      ))}
          ...
          <section className="max-w-4xl mx-auto px-6 py-20">
            ...
            <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
              {data.education.items.map((item, i) => (
                <div key={i} className="bg-white dark:bg-[#162032]/40 rounded-2xl border border-zinc-100 dark:border-white/[0.05] p-6 text-center hover:border-violet-200 dark:hover:border-violet-800/40 transition-all">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-3xl mx-auto">
                {data.certifications.items.map((item, i) => (
                  <div key={i} className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-white/[0.05] p-6 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all group">
          ...
          <section className="max-w-4xl mx-auto px-6 py-20">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {data.tools.items.map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-white dark:bg-[#162032]/40 border border-zinc-100 dark:border-white/[0.05] hover:border-violet-200 dark:hover:border-violet-800/40 hover:bg-violet-50/50 dark:hover:bg-violet-900/20 transition-all group"
                >
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {data.values.items.map((item, i) => (
                  <div
                    key={i}
                    className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-white/[0.05] p-5 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all group"
                  >
