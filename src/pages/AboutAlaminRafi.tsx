    ...
    <div className="min-h-screen bg-white dark:bg-[#0F172A]">
      ...
      <main>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="mb-8 inline-block">
                <img
                  ...
                  loading="lazy"
                  decoding="async"
                  className="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-white dark:border-[#1E3A5F] shadow-xl shadow-violet-500/10"
                />
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {data.hero.socialLinks.map((social) => (
                  <a
                    ...
                    className="px-4 py-2 rounded-xl bg-white/80 dark:bg-white/[0.05] border border-zinc-100 dark:border-[#1E3A5F] text-sm font-bold text-zinc-700 dark:text-zinc-300 hover:text-violet-600 dark:hover:text-violet-400 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all"
                  >
                    {social.platform}
                  </a>
                ))}
        ...
        {data.visibility.focus && (
          <section className="bg-zinc-50 dark:bg-[#162032]/20 px-6 py-20">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {data.focus.items.map((item, i) => (
                  <div
                    key={i}
                    className="group p-6 rounded-2xl bg-white dark:bg-[#162032]/60 border border-zinc-100 dark:border-[#1E3A5F] hover:border-violet-200 dark:hover:border-violet-800/40 hover:shadow-lg hover:shadow-violet-500/5 transition-all"
                  >
              ...
              <div className="space-y-8">
                {data.experience.items.map((item, i) => (
                  <div key={i} className="relative sm:pl-14">
                    <div className="hidden sm:flex absolute left-2.5 top-1.5 w-5 h-5 rounded-full bg-white dark:bg-[#162032] border-2 border-violet-500 items-center justify-center z-10">
                    ...
                    <div className="bg-white dark:bg-[#162032]/40 rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] p-6 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all">
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 mb-3">
                        ...
                        <span className="hidden sm:block text-xs font-bold text-zinc-500 dark:text-zinc-400 bg-zinc-100 dark:bg-[#1E293B] px-3 py-1 rounded-lg shrink-0">{item.period}</span>
                      </div>
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.skills.categories.map((cat, i) => (
                  <div key={i} className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {cat.items.map((skill, j) => (
                        <span
                          key={j}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-100 dark:bg-[#1E293B] text-xs font-medium text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-[#1E3A5F]"
                        >
                          {skill}
                        </span>
                      ))}
          ...
          <section className="max-w-4xl mx-auto px-6 py-20">
            ...
            <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
              {data.education.items.map((item, i) => (
                <div key={i} className="bg-white dark:bg-[#162032]/40 rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] p-6 text-center hover:border-violet-200 dark:hover:border-violet-800/40 transition-all">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-3xl mx-auto">
                {data.certifications.items.map((item, i) => (
                  <div key={i} className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] p-6 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all group">
          ...
          <section className="max-w-4xl mx-auto px-6 py-20">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {data.tools.items.map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-white dark:bg-[#162032]/40 border border-zinc-100 dark:border-[#1E3A5F] hover:border-violet-200 dark:hover:border-violet-800/40 hover:bg-violet-50/50 dark:hover:bg-violet-900/20 transition-all group"
                >
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {data.values.items.map((item, i) => (
                  <div
                    key={i}
                    className="bg-white dark:bg-[#162032]/60 rounded-2xl border border-zinc-100 dark:border-[#1E3A5F] p-5 hover:border-violet-200 dark:hover:border-violet-800/40 transition-all group"
                  >
            ...
            <div className="relative max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-cyan-500 text-[#0F172A] font-bold text-sm hover:brightness-110 transition-all shadow-lg shadow-violet-500/20"
                >
                ...
                <Link
                  to="/portfolio"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl border border-zinc-200 dark:border-[#1E3A5F] text-zinc-900 dark:text-white font-bold text-sm hover:border-violet-200 dark:hover:border-violet-800/40 hover:text-violet-600 dark:hover:text-violet-400 transition-all"
                >
