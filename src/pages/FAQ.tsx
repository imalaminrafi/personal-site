  ...
  return (
    <PublicLayout>
      <section className="max-w-2xl mx-auto px-5 sm:px-6 py-10 sm:py-16">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {items.map((item, i) => (
              <AccordionItem
                key={i}
                value={`faq-${i}`}
                className="rounded-2xl border border-zinc-100 px-4 dark:border-white/[0.06] bg-zinc-50/60 dark:bg-zinc-900/40"
              >
        ...
        <div className="mt-10 rounded-2xl border border-zinc-100 dark:border-white/[0.06] bg-zinc-50/60 dark:bg-zinc-900/40 p-6 text-center">
