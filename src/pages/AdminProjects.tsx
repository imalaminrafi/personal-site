...
function ProjectForm({
    ...
    return (
        <div className="space-y-5">
            {/* Basic info */}
            <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-5 space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full text-sm py-2 px-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-[#1E293B] text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500/40"
                        >
            ...
            {/* Status message */}
            <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-5 space-y-3">
            ...
            <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-5 space-y-4">
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 text-sm py-2 px-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-[#1E293B] text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500/40"
                    />
            ...
            <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => onSave(p)}
                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-cyan-500 text-[#0F172A] text-sm font-semibold hover:opacity-90 transition-opacity"
                    >
...
function Field({
    ...
    const cls = "w-full text-sm py-2 px-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-[#1E293B] text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-500/40";
    return (
        <div>
...
export default function AdminProjectsPage() {
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-[#0F172A] pb-16">
            ...
            {/* Header */}
            <header className="bg-white dark:bg-[#162032] border-b border-zinc-100 dark:border-zinc-800 px-5 py-4">
                <div className="max-w-2xl mx-auto flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-violet-600 to-cyan-500 text-[#0F172A] text-xs font-semibold hover:opacity-90 transition-opacity"
                    >
            ...
            <main className="max-w-2xl mx-auto px-5 py-8 space-y-5">
                ...
                {!editing && (
                    <>
                        ...
                        {projects.length === 0 && (
                            <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-10 text-center">
                                <p className="text-sm text-zinc-400">No projects yet. Create your first one!</p>
                            </div>
                        )}
                        <div className="space-y-3">
                            {projects.map(p => (
                                <div key={p.id} className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm overflow-hidden">
                                    <button
