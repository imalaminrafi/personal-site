...
const statusStyle: Record<string, string> = {
    ...
    "In Progress": "bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-800",
    ...
    if (project === null) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-zinc-50 dark:bg-[#0F172A] px-6 text-center">
                ...
                <button
                    onClick={() => navigate("/")}
                    className="mt-2 inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium bg-white dark:bg-[#1E293B] border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-200 hover:border-violet-400 transition-colors"
                >
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-[#0F172A] pb-24">
            ...
            <main className="max-w-2xl mx-auto px-5 py-8 space-y-6">
                ...
                <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm">
                            ...
                            return (
                                <div key={step} className="flex items-center gap-3">
                                    ...
                                    <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-xs font-bold transition-all
                                        ${done    ? "bg-gradient-to-br from-violet-600 to-cyan-500 text-[#0F172A]" : ""}
                                        ${current ? "ring-2 ring-violet-500 ring-offset-2 dark:ring-offset-zinc-900 bg-violet-500 text-[#0F172A]" : ""}
                                ...
                                <div key={i} className="relative">
                                    ...
                                    <span className={`absolute -left-[17px] top-1.5 w-2.5 h-2.5 rounded-full border-2 ${
                                        i === 0
                                            ...
                                            : "bg-white dark:bg-[#162032] border-zinc-200 dark:border-zinc-700"
                                    }`} />
                ...
                <div className="bg-white dark:bg-[#162032] rounded-2xl border border-zinc-100 dark:border-zinc-800 p-5 shadow-sm">
