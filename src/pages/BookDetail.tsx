    ...
    <PublicLayout>
      <section className="mx-auto max-w-4xl px-5 py-10 sm:px-6 sm:py-14">
        ...
        <div className="flex flex-col gap-8 sm:flex-row">
          {/* Cover */}
          <div className="relative aspect-[16/10] w-full shrink-0 overflow-hidden rounded-2xl border border-zinc-200/80 bg-zinc-100 dark:border-white/[0.08] dark:bg-zinc-900 sm:aspect-auto sm:h-72 sm:w-56">
            {book.cover ? (
              <img
